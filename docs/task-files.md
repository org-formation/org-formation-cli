...
| TaskViaRoleArn                   | string                                                                                                                                                                                          | Specifies ARN of the IAM Role that will be assumed before assuming role specified by the `TaskRoleName`. This role is expected to exist in the target account (and have the right AssumeRole permissions).                                                                                            |
